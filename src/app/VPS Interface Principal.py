...
class JanelaPrincipal:
    ...
    def Widgets(self):
        ...
        self.wallpaper = ImageTk.PhotoImage(Image.open('images/imagem7.gif'))
...
class JanelaConfigSaldo:
    ...
    def Widgets(self):
        ...
        self.wallpaper2 = ImageTk.PhotoImage(Image.open('images/saldo.gif'))
...
class JanelaConfDespesas:
    ...
    def Widgets(self):
        ...
        self.wallpaper2 = ImageTk.PhotoImage(Image.open('images/despesas.jpg'))
        self.canvas.create_image(0, 0, anchor=NW, image=self.wallpaper2)
...
class JanelaDespesas:
    ...
    def Widgets(self):
        ...
        self.wallpaper2 = ImageTk.PhotoImage(Image.open('images/visualizador.jpg'))
        self.canvas.create_image(0, 0, anchor=NW, image=self.wallpaper2)
...
class JanelaDespesasVisualizador:
    def TodasDespesas(self):
        ...
        wallpaper2 = ImageTk.PhotoImage(Image.open('images/visualizador.jpg'))
